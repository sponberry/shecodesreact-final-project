...
export default function WeatherDisplay(props) {
  let [windUnit, setWindUnit] = useState("km ")
  ...
  function celsius(event) {
    ...
    props.tempUnit("metric");
    setWindUnit("km ");
  }

  function fahrenheit(event) {
    event.preventDefault();
    props.tempUnit("imperial");
    setWindUnit("m")
  }
    ...
    <div className="allWeather">
      ...
      <div className="row ml-2">
        <div className="col-sm-4 col-md-6">
          ...
          <p className="mt-2 mb-0">{props.data.temperature}
          <a href="/" rel="norefferer" onClick={celsius}>°C</a> | <a href="/" rel="norefferer" onClick={fahrenheit}>°F</a></p>
        ...
        <div className="col-sm-5 col-md-6">
          <ul className="mt-1">
            ...
            <li className="weatherStats mb-1">
              wind {props.data.wind} {windUnit}p/h
            </li>
          </ul>
        </div>
      </div>
